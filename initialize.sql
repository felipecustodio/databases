...
CREATE TABLE ALOCACAO(
    ...
    CONSTRAINT FK_NRO_BALCAO    FOREIGN KEY(NRO_BALCAO)      REFERENCES BAR(NRO_BALCAO)       ON DELETE CASCADE,
    CONSTRAINT FK_DATA          FOREIGN KEY(DIA, HORA)       REFERENCES DATA_ALOCACAO(DIA,HORA) ON DELETE CASCADE, -- CHECAR SET NULL
...
CREATE TABLE COMANDA(
    ...
    CONSTRAINT FK_CODIGO_FANTASIA FOREIGN KEY(CODIGO_FANTASIA)        REFERENCES FANTASIA(CODIGO_BARRAS)  ON DELETE CASCADE,
...
CREATE TABLE ALUGUEL(
    ...
    CONSTRAINT FK_CODIGO_FANTASIA FOREIGN KEY(CODIGO_FANTASIA)       REFERENCES FANTASIA(CODIGO_BARRAS)  ON DELETE CASCADE, -- CHECAR OS SET NULL E CASCADE
...
CREATE TABLE CONTRATO_DJ(
    ...
    HORA_BALADA     TIME        NOT NULL,                   --CHECAR SE PODE COLOCAR COM DATA
    DJ              VARCHAR(20) NOT NULL,
    VALOR_PAGO      REAL                    DEFAULT '0',
...
CREATE TABLE REGISTRA_BEBIDA(
    ...
    CONSTRAINT  FK_CODIGO           FOREIGN KEY(CODIGO)                    REFERENCES COMANDA(CODIGO)                    ON DELETE CASCADE,
    CONSTRAINT  FK_NRO_BALCAO       FOREIGN KEY(NRO_BALCAO, CODIGO_BARRAS) REFERENCES BEBIDA(NRO_BALCAO, CODIGO_BARRAS)  ON DELETE CASCADE-- CHECAR SET NULL
);
