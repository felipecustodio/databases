...
CREATE TABLE CONTRATO_BANDA(
    ...
    CONSTRAINT  FK_BANDA            FOREIGN KEY(BANDA)                         REFERENCES BANDA(NOME)          ON UPDATE CASCADE ON DELETE CASCADE, -- CHECAR CASCADE
    CONSTRAINT  FK_CARNAVAL         FOREIGN KEY(DIA_CARNAVAL, HORA_CARNAVAL)   REFERENCES CARNAVAL(DIA,HORA)   ON UPDATE CASCADE ON DELETE CASCADE  -- CHECAR CASCADE E ARRUMAR DIA HORA
...
CREATE TABLE SHOW_DJ(
    ...
    CONSTRAINT  FK_DJ        FOREIGN KEY(DJ)    REFERENCES DJ(NOME)         ON UPDATE CASCADE ON DELETE CASCADE,  -- CHECAR CASCADE
    CONSTRAINT  FK_PALCO     FOREIGN KEY(PALCO) REFERENCES PALCO(NRO_PALCO) ON UPDATE CASCADE ON DELETE CASCADE  -- CHECAR CASCADE
);
...
CREATE TABLE CONTRATO_DJ(
    ...
    CONSTRAINT  FK_BALADA      FOREIGN KEY(DIA_BALADA, HORA_BALADA)  REFERENCES BALADA(DIA, HORA) ON UPDATE CASCADE ON DELETE CASCADE, -- CHECAR DELETE CASCADE E DIA HORA_FESTA
    CONSTRAINT  FK_DJ          FOREIGN KEY(DJ)                       REFERENCES DJ(NOME)          ON UPDATE CASCADE ON DELETE CASCADE, -- CHECAR CASCADE
...
CREATE TABLE PARTICIPACAO(
    ...
    CONSTRAINT FK_DATA         FOREIGN KEY(DIA, HORA) REFERENCES CARNAVAL(DIA,HORA) ON UPDATE CASCADE ON DELETE CASCADE --CHECAR A FORMA DE DATA
